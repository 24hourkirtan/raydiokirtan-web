        ...
        <div class="main-content clearfix">
            ...
            <div class="main-content-right">
                ...
                <div class="social-now-playing box">
                    <div class="box-inner">
                        <div class="social">
                            <a href="#" class="icon icon-email" target="_blank"><span></span></a>
                            <a href="#" class="icon icon-instagram" target="_blank"><span></span></a> 
                            <a href="#" class="icon icon-facebook" target="_blank"><span></span></a>
                        </div>
                    </div>
